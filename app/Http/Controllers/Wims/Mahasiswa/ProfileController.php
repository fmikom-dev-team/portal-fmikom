...
use App\Services\Wims\Mahasiswa\Profile\StudentProfilePageService;
use App\Services\Wims\Mahasiswa\Profile\StudentProfileUpdateService;
...
class ProfileController extends Controller
{
    ...
    {
        return Inertia::render('Wims/Mahasiswa/Profile', $this->studentProfilePageService->build($request->user()));
    }
