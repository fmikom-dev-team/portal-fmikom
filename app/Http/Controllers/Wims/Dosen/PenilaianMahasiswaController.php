...
use App\Models\User;
use App\Services\Wims\Shared\Assessment\AssessmentIndexService;
use App\Services\Wims\Shared\Assessment\AssessmentShowService;
use App\Services\Wims\Shared\Assessment\AssessmentSubmissionService;
use App\Services\Wims\Shared\Assessment\AssessmentTemplateResolverService;
use App\Services\Wims\Dosen\LecturerAssessmentWorkflowService;
...
class PenilaianMahasiswaController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('Wims/Dosen/PenilaianMahasiswa/Index', [
    ...
    public function show(Request $request, PendaftaranMagang $pendaftaran): Response
    {
        ...
        return Inertia::render('Wims/Dosen/PenilaianMahasiswa/Show', $payload);
    }
