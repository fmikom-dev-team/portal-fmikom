...
class UpdatePortfolioRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'content.*.file' => ['nullable', 'file', 'extensions:jpeg,jpg,png,gif,webp,avif,heic,heif,svg,bmp,mp4,mov,avi,webm,mkv,3gp,mp3,wav,ogg,pdf,zip,rar,tar,7z', 'max:102400', new VideoDurationRule],
            'content.*.files.*' => ['nullable', 'file', 'extensions:jpeg,jpg,png,gif,webp,avif,heic,heif,svg,bmp,mp4,mov,avi,webm,mkv,3gp', 'max:102400', new VideoDurationRule],
