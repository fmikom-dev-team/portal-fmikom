...
return [
    ...
    */
    ...
    'exclude_analyzers' => [
        HSTSHeaderAnalyzer::class,
        XSSAnalyzer::class,
        PHPIniAnalyzer::class,
        ConfigCachingAnalyzer::class,
        DevDependencyAnalyzer::class,
        MinificationAnalyzer::class,
        MysqlSingleServerAnalyzer::class,
        QueueDriverAnalyzer::class,
        RouteCachingAnalyzer::class,
        UnusedGlobalMiddlewareAnalyzer::class,
        ViewCachingAnalyzer::class,
    ],
