            ...
            <div class="flex items-start justify-between gap-4">
                <div class="flex-1">
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Pantau status QR Code surat keluar.
                    </p>
                </div>
        ...
        <div class="space-y-3">
            ...
            >
                ...
                <div class="mt-4 flex items-center gap-2">
                    ...
                    <button
                        v-if="item.qr_token && can('fast.admin.qr.manage')"
                        type="button"
                    ...
                    >
                        <XCircle class="size-3.5" /> Nonaktif
                    </div>
                </div>
            </div>
        </div>
