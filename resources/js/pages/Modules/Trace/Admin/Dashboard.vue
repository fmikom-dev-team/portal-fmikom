    ...
    <TraceAdminLayout title="Dashboard" :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-4 max-w-7xl mx-auto w-full pb-12">
            ...
            <div v-if="props.stats" class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Link href="/trace/admin/jobs?status=pending_review" class="group flex items-center gap-4 rounded-2xl border border-slate-100 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-4 shadow-xs transition-all hover:shadow-md hover:border-amber-200 dark:hover:border-amber-800">
