...
const enterSystem = (moduleCode: string) => {
    ...
    if (!roleSlug) return;
    console.log(moduleCode, roleSlug);
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div
            class="relative flex min-h-[calc(100vh-4rem)] flex-1 flex-col overflow-hidden rounded-xl max-md:rounded-none p-4 sm:p-6 lg:p-10 bg-[#f8f9fc] max-md:bg-transparent dark:bg-zinc-950 max-md:dark:bg-transparent"
        >
            <!-- Decorative Blobs Behind Content -->
            <div
                class="pointer-events-none absolute -left-40 top-0 h-96 w-96 rounded-full bg-[#2563EB]/10 blur-[100px]"
            ></div>
            <div
                class="pointer-events-none absolute -right-20 bottom-0 h-80 w-80 rounded-full bg-[#B6FF00]/10 blur-[80px]"
            ></div>

            <!-- LOADING SKELETON HEADER -->
            <div
                v-if="isLoading"
                class="relative z-10 mb-8 sm:mb-12 max-w-3xl animate-pulse"
            >
                <div class="mb-3 flex items-center gap-2 sm:gap-3">
                    <div
                        class="h-10 sm:h-12 lg:h-[3.25rem] w-48 bg-slate-200 dark:bg-zinc-800 rounded-xl"
                    ></div>
                </div>
                <div class="mb-4 sm:mb-5 space-y-2">
                    <div
                        class="h-9 sm:h-11 lg:h-[3rem] w-[80%] max-w-lg bg-slate-200 dark:bg-zinc-800 rounded-xl"
                    ></div>
                    <div
                        class="h-9 sm:h-11 lg:h-[3rem] w-[60%] max-w-md bg-slate-200 dark:bg-zinc-800 rounded-xl"
                    ></div>
                </div>
                <div class="space-y-1.5 mt-4">
                    <div
                        class="h-4 w-[90%] max-w-xl bg-slate-200 dark:bg-zinc-800 rounded-lg"
                    ></div>
                    <div
                        class="h-4 w-[50%] max-w-sm bg-slate-200 dark:bg-zinc-800 rounded-lg"
                    ></div>
                </div>
            </div>
            ...
            <div v-else class="relative z-10 mb-8 sm:mb-12 max-w-3xl">
                ...
                <div class="mb-1 flex items-center gap-2 sm:gap-3">
                    <h1
                        class="text-3xl sm:text-4xl lg:text-[3.25rem] font-bold tracking-tight text-[#0f172a] dark:text-white leading-none"
                    >
                ...
                <!-- Big Subheading -->
                <h2
                    class="mb-4 sm:mb-5 text-3xl sm:text-4xl lg:text-[3.25rem] font-bold tracking-tight text-[#0f172a] dark:text-gray-200 leading-tight lg:leading-[1.1]"
                >
            ...
            <div
                v-if="!isLoading && flash.status"
                class="relative z-10 rounded-xl bg-[#B6FF00]/20 p-4 mb-6 text-sm font-semibold text-green-900 border border-[#B6FF00]/50 backdrop-blur-md dark:text-[#B6FF00]"
            >
                {{ flash.status }}
            </div>
            <div
                v-if="!isLoading && flash.error"
                class="relative z-10 rounded-xl bg-red-50 p-4 mb-6 text-sm font-semibold text-red-800 border border-red-200 backdrop-blur-md"
            >
                {{ flash.error }}
            </div>
            ...
            <div
                v-if="isLoading"
                class="relative z-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4"
            >
                <div
                    v-for="i in 4"
                    :key="i"
                ...
                >
                    ...
                    <div
                        class="relative h-[220px] w-full bg-slate-50 dark:bg-zinc-800/40 rounded-[1rem] flex items-center justify-center border border-slate-100 dark:border-zinc-800"
                    >
                        <div
                            class="h-28 w-28 rounded-full bg-slate-200/60 dark:bg-zinc-700/60"
                        ></div>
                        <div
                            class="absolute left-4 top-4 h-6 w-28 bg-slate-200/80 dark:bg-zinc-700/80 rounded-full"
                        ></div>
                    </div>
                    <!-- Bottom Detail Skeleton -->
                    <div class="flex flex-1 flex-col p-4 pt-5">
                        <div
                            class="h-6 w-20 bg-slate-200 dark:bg-zinc-800 rounded-lg mb-3"
                        ></div>
                        <div class="space-y-2 mt-2">
                            <div
                                class="h-3 w-full bg-slate-200 dark:bg-zinc-800 rounded-md"
                            ></div>
                            <div
                                class="h-3 w-[85%] bg-slate-200 dark:bg-zinc-800 rounded-md"
                            ></div>
                        </div>
                        <div class="mt-auto pt-6">
                            <div
                                class="h-[48px] w-full bg-slate-200 dark:bg-zinc-800 rounded-xl"
                            ></div>
                        </div>
                    </div>
                </div>
            ...
            >
                ...
                >
                    ...
                    <div
                        ...
                        :class="
                            flippedModuleCode === mod.code ? 'rotate-y-180' : ''
                        "
                    >
                        <!-- =========================
                        ...
                        <div
                            ...
                            :class="
                                !userRolesByModule[mod.code] ||
                                userRolesByModule[mod.code].length === 0
                                    ? 'opacity-80 grayscale cursor-not-allowed'
                                    : 'cursor-pointer hover:-translate-y-2 hover:shadow-2xl hover:ring-[#2563EB]/50 transition-all duration-300'
                            "
                            @click="
                                !userRolesByModule[mod.code] ||
                                userRolesByModule[mod.code].length === 0
                        ...
                        >
                            <!-- Top Header Box -->
                            <div
                                class="relative h-[220px] w-full overflow-hidden rounded-[1rem] bg-slate-50 dark:bg-white/5 border border-white/40 dark:border-white/10 shadow-inner"
                            >
                                ...
                                >
                                    <div
                                        class="absolute h-40 w-40 rounded-full bg-[#2563EB]/10 blur-3xl transition-all duration-500"
                                    ></div>
                                    <img
                                        :src="mod.image"
                                        :alt="mod.name"
                                        class="relative z-10 max-h-[140px] max-w-[80%] object-contain transition-transform duration-500 hover:scale-105"
                                    />
                                </div>
                                <!-- Status Overlay -->
                                <div class="absolute left-4 top-4 z-20">
                                    <span
                                        v-if="
                                            userRolesByModule[mod.code] &&
                                            userRolesByModule[mod.code].length >
                                                0
                                        "
                                        class="inline-flex items-center gap-1.5 rounded-full bg-white/90 px-3 py-1.5 text-[11px] font-bold uppercase tracking-wider text-[#2563EB] shadow-sm backdrop-blur-md"
                                    >
                                        <svg
                                            class="h-3.5 w-3.5"
                                            viewBox="0 0 20 20"
                                    ...
                                    <span
                                        v-else
                                        class="inline-flex items-center gap-1.5 rounded-full bg-zinc-800/80 px-3 py-1.5 text-[11px] font-bold uppercase tracking-wider text-white shadow-sm backdrop-blur-md"
                                    >
                                        🔒 Terkunci
                                    </span>
                                </div>
                            ...
                            <div class="flex flex-1 flex-col p-4 pt-5">
                                <h2
                                    class="text-xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent dark:from-white dark:to-gray-400"
                                >
                                    {{ mod.name }}
                                </h2>
                                <p
                                    class="text-sm font-medium text-gray-500 dark:text-gray-400 mt-2 line-clamp-3"
                                >
                                    {{ mod.desc }}
                                </p>
                        ...
                        >
                            <!-- Profile / Top Area -->
                            <div
                                class="flex shrink-0 items-center gap-3 border-b border-gray-100 pb-4 dark:border-zinc-800"
                            >
                                <div
                                    class="relative flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-gray-100 dark:bg-zinc-800 shadow-inner overflow-hidden border border-gray-200 dark:border-zinc-700"
                                >
                                    <!-- Initial Username Avatar -->
                                    <span
                                        class="text-[22px] font-black text-[#2563EB]"
                                ...
                                >
                                    <div class="flex items-center gap-2">
                                        <h3
                                            class="truncate text-base font-bold leading-tight text-gray-900 dark:text-white"
                                        >
                                            {{ user.name }}
                                        </h3>
                                        <!-- Verified Badge -->
                                        <span
                                            class="inline-flex shrink-0 items-center gap-1 rounded bg-green-50 px-1.5 py-0.5 text-[9px] font-bold text-green-600 border border-green-200 dark:border-green-900/50 dark:bg-green-900/20 dark:text-green-400"
                                        >
                                            <svg
                                                class="h-2.5 w-2.5"
                                                viewBox="0 0 20 20"
                                    ...
                                    <p
                                        class="mt-0.5 truncate text-[13px] font-medium text-gray-500"
                                    >
                                        {{ user.email }}
                                    </p>
                                </div>
                            ...
                            <div class="my-3 flex-1 overflow-y-auto pr-1">
                                <h4
                                    class="mb-3 text-[11px] font-bold uppercase tracking-wider text-gray-400"
                                >
                                    Pilih Otorisasi Akses
                                </h4>

                                <div class="space-y-2.5">
                                    <label
                                        v-for="(role, idx) in userRolesByModule[
                                            mod.code
                                        ]"
                                        :key="idx"
                                        class="flex cursor-pointer items-center justify-between rounded-xl border p-3 transition-all duration-200"
                                        :class="
                                            selectedRoleSlug[mod.code] ===
                                            role.slug
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <div
                                                    class="h-2 w-2 rounded-full bg-[#2563EB] transition-transform"
                                                    :class="
                                                        selectedRoleSlug[
                                                            mod.code
                                                        ] === role.slug
                                            ...
                                            >
                                                <span
                                                    class="truncate text-sm font-bold text-gray-900 dark:text-gray-100"
                                                    >{{
                                                        role.nama ||
                                                        role.name ||
                                                        role.slug
                                        ...
                                        <input
                                            type="radio"
                                            :value="role.slug"
                                            v-model="selectedRoleSlug[mod.code]"
                                            class="hidden"
                                        />
                                    </label>
                                </div>
                            ...
                            <div
                                class="mt-auto flex shrink-0 items-center gap-2 pt-2"
                            >
                                <button
