...
export const TRACE_ROUTES = {
    ...
    ADMIN_QUESTIONNAIRE_DETAIL: (id: number) => `/trace/admin/questionnaires/${id}`,
    ADMIN_QUESTIONNAIRE_ANALYTICS: (id: number) => `/trace/admin/questionnaires/${id}/analytics`,
    ...
    API_NOTIFICATIONS_MARK_READ: (id: string) => `/trace/notifications/${id}/read`,
