...
const iconCircleClasses = computed(() => {
    const colorMap: Record<NonNullable<Props["color"]>, string> = {
        primary:
            "bg-[#0C447C]/10 text-[#0C447C] dark:bg-[#85B7EB]/15 dark:text-[#85B7EB]",
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <div class="mt-1.5 flex items-end gap-2.5">
                            <h2
                                class="text-xl lg:text-2xl font-black leading-none tracking-tight text-slate-900 dark:text-white"
                                style="
